...
{
  cout<<"*************** This is the final TRANSITION TABLE ***************\n\n";
  cout<<"###########################\n";
  cout<<"State "<<"|"<<" Input | "<<" Result \n";
  cout<<"###########################\n";
  for(auto it = this->transition.begin(); it != this->transition.end(); it++)
  {
    cout<<setw(3)<<it->first[0]<<" ";
    cout<<setw(6)<<it->first[1]<<" ";
    cout<<setw(9)<<it->second<<" ";
    cout<<"\n";
  }
}
